    ...
    <div className='about-container'>
        <div className="about-box">
                    ...
                    <div className="box-right">
                        ...
                        <p className="info-mobile">My name is Oz Birdett and I graduated from the University of North Texas with a bachelor’s degree in Computer Science. I've always been passionate about solving problems, never being able to get enough of the satisfaction that comes from a solution.</p>
                        <p className="info-mobile">Over the years I’ve been able to find that satisfaction and grow my problem solving skills from coding and providing technical support. I hope to be able to continue my passion for problem solving at my next career.</p>
                    </div>
                </div>
    </div>
  )
